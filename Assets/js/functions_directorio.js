...
document.addEventListener('DOMContentLoaded', function(){
    ...
    tableCategorias = $('#tableCategorias').dataTable( {
        ...
        "ajax":{
            "url": " "+base_url+"/Directorio/getCategorias",
            "dataSrc":""
        },
        "columns":[
            {"data":"idcategoria"},
    ...
    formCategoria.onsubmit = function(e) {
        ...
        let ajaxUrl = base_url+'/Directorio/setCategoria'; 
...
function fntViewInfo(idcategoria){
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Directorio/getCategoria/'+idcategoria;
...
function fntDelInfo(idcategoria){
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Directorio/delCategoria';
