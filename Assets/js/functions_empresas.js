...
tableProductos = $('#tableProductos').dataTable( {
    ...
    "ajax":{
        "url": " "+base_url+"/Empresas/getProductos",
        "dataSrc":""
    },
    "columns":[
        {"data":"idproducto"},
...
window.addEventListener('load', function() {
    if(document.querySelector("#formProductos")){
        ...
        formProductos.onsubmit = function(e) {
            ...
            let ajaxUrl = base_url+'/Empresas/setProducto'; 
...
function fntViewInfo(idProducto){
    let request = (window.XMLHttpRequest) ? 
                    new XMLHttpRequest() : 
                    new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Empresas/getProducto/'+idProducto;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#celCorregimiento").innerHTML = objProducto.corregimiento;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200)
        {
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#listCorregimientoid").value = objProducto.corregimientoid;
...
function fntDelInfo(idProducto){
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Empresas/delProducto';
...
function fntCategorias(){
    if(document.querySelector('#listCategoria')){
        let ajaxUrl = base_url+'/Empresas/getSelectCategorias';
        let request = (window.XMLHttpRequest) ? 
                    new XMLHttpRequest() : 
                    new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET",ajaxUrl,true);
...
function fntCorregimiento(){
        ...
        let ajaxUrl = base_url+'/Empresas/getSelectCorregimiento';
        let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET",ajaxUrl,true);
        request.send();
        request.onreadystatechange = function()
