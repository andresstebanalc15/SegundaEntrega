...
window.addEventListener('load', function(){
	...
	tableIdentificacion = $('#tableIdentificacion').dataTable( {
        ...
        "ajax":{
            "url": " "+base_url+"/Identificacion/getIdentificaciones",
            "dataSrc":""
        },
        "columns":[
            {"data":"id"},
	...
	if(document.querySelector('#formIdentificacion')){
        ...
        formIdentificacion.onsubmit = function(e){
            ...
            let ajaxUrl = base_url+'/Identificacion/setIdentificacion';
    ...
    if(document.querySelector('#formAprobarPqrsd')){
        ...
        formAprobarPqrsd.onsubmit = function(e){
            ...
            let request = (window.XMLHttpRequest) ?
                            new XMLHttpRequest() : 
                            new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Identificacion/setRadicado';
    ...
    if(document.querySelector('#formFinalizarPqrsd')){
        ...
        formFinalizarPqrsd.onsubmit = function(e){
            ...
            let request = (window.XMLHttpRequest) ?
                            new XMLHttpRequest() : 
                            new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Identificacion/setFinalizado';
    ...
    if(document.querySelector('#formAsignarPqrsd')){
        ...
        formAsignarPqrsd.onsubmit = function(e){
            ...
            let request = (window.XMLHttpRequest) ?
                            new XMLHttpRequest() : 
                            new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Identificacion/setResponsable';
...
function fntAsignarPqr(idpqr){
    ...
    let ajaxUrl = base_url+'/Identificacion/getIdentificacion/'+idpqr; 
...
function fntEditarPqr(idpqr){
    ...
    var ajaxUrl = base_url+'/Identificacion/getIdentificacion/'+idpqr;
    request.open("GET",ajaxUrl,true);
    request.send();
    request.onreadystatechange = function(){
