...
document.addEventListener('DOMContentLoaded', function(){
    ...
    if(document.querySelector("#formIdentificacion")){
        ...
        formIdentificacion.onsubmit = function(e) {
            ...
            if(listTipoSolicitudid == '' || listMedioid == '' || listTipoid == '' || txtIdentificacion == '' || listSolicitanteid == '' || txtNombrea == '' || txtApellidoa == '' || listAreaId == '' 
                || listPaisId == '' || listDepartamentoid == '' || listMunicipioid == '' || listCorregimientoid == '')
            {
            ...
            var ajaxUrl = base_url+'/Identificado/setIdentificacion'; 
...
function fntTipoSolicitud(){
    ...
    {
        let ajaxUrl = base_url+'/Identificado/getSelectTipoSolicitud';
        let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET",ajaxUrl,true);
        request.send();
        request.onreadystatechange = function()
...
function fntMedioRespuesta(){
    ...
    {
        let ajaxUrl = base_url+'/Identificado/getSelectMedio';
        let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET",ajaxUrl,true);
        request.send();
        request.onreadystatechange = function()
