...
tableUsuarios = $('#tableUsuarios').dataTable( {
        ...
        "ajax":{
            "url": " "+base_url+"/Persona/getUsuarios",
            "dataSrc":""
        },
        "columns":[
            {"data":"idpersona"},
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    if(document.querySelector("#formUsuario")){
        ...
        formUsuario.onsubmit = function(e) {
            ...
            let ajaxUrl = base_url+'/Persona/setUsuario'; 
    ...
    if(document.querySelector("#formPerfil")){
        ...
        formPerfil.onsubmit = function(e) {
            ...
            divLoading.style.display = "flex";
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Persona/putPerfil'; 
    ...
    if(document.querySelector("#formDataFiscal")){
        ...
        formDataFiscal.onsubmit = function(e) {
            ...
            divLoading.style.display = "flex";
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/PErsona/putDFical'; 
...
function fntArea(){
    ...
    {
        let ajaxUrl = base_url+'/Identificado/getSelectArea';
        let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET",ajaxUrl,true);
        request.send();
        request.onreadystatechange = function()
...
function fntViewUsuario(idpersona){
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Persona/getUsuario/'+idpersona;
    request.open("GET",ajaxUrl,true);
    request.send();
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
               let estadoUsuario = objData.data.status == 1 ? 
                ...
                document.querySelector("#celAreaUsuario").innerHTML = objData.data.nombre;
    ...
    request.onreadystatechange = function(){
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#listAreaId").value =objData.data.areaid;
                $('#listAreaId').selectpicker('render');
...
function fntDelUsuario(idpersona){
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Persona/delUsuario';
