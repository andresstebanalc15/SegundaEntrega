        ...
        request.onreadystatechange = function(){
           if(request.readyState == 4 && request.status == 200){
                ...
                if(objData.status)
                {
                    ...
                    formSlider.reset();
                    swal("Slider", objData.msg ,"success");
                    removePhoto();
                }else{
...
function fntEditInfo(element,idslider){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                document.querySelector("#idSlider").value = objData.data.idimg;
                document.querySelector("#txtNombre").value = objData.data.nombre;
                document.querySelector("#txtDescripcion").value = objData.data.descripcion;
                document.querySelector("#txtNombreUrl").value = objData.data.enlace;
                document.querySelector("#txtUrl").value = objData.data.enlace_url;
                document.querySelector("#txtNombreVideo").value = objData.data.video;
                document.querySelector("#txtEWnlaceVideo").value = objData.data.video_url;
...
function fntDelInfo(idslider){
    swal({
        ...
        text: "¿Realmente quiere eliminar el Slider?",
        type: "warning",
