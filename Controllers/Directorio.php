<?php
	class Directorio extends Controllers{
		...
		public function Directorio()
		{
			...
			$data['page_title'] = "CATEGORIAS <small>Directorio Comercial</small>";
			$data['page_name'] = "directorio";
			$data['page_functions_js'] = "functions_directorio.js";
