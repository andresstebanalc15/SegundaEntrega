<?php
	...
	class Identificado extends Controllers{
		...
		{
			$pageContent = getPageRout('identificado');
			if(empty($pageContent)){
				header("Location: ".base_url());
			}else{
				$data['page_tag'] = $pageContent['titulo']." - ".NOMBRE_EMPESA;
				$data['page_title'] = 'PQRS con Identificación';
				$data['page_name'] = $pageContent['titulo'];
				$data['page'] = $pageContent;
				$data['page_functions_js'] = "functions_identificado.js";
				$this->views->getView($this,"identificado",$data);  
			}
