...
<main class="app-content">
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?= base_url(); ?>/identificacion"> PQRSD con Identificación</a></li>
    </ul>
  </div>
  <div class="row">
      <div class="col-md-12">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      ?>
                        <td><a href="<?= media(); ?>/images/pqri/<?= $trazabilidad['adjunto']; ?>" target="_blanck"><i class="fas fa-file-pdf"></i></a></td>
                      <?php  
                        }
                      ?>
                    </tr>
