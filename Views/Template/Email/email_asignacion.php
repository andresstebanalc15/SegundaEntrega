	...
	<table align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="text-align:center;">
		<tbody>
			...
			<tr>
				<td>
					<div class="x_sgwrap">
						<p>Reasignación de Solicitud</p>
					</div>
					<p>Bienvenido a Tramip.</p>
					<p>Sistema de Información Tramites, Peteciones, Quejas, Reclamos, Sugerencias y Denuncias.</p>
					
					<p>Tienes una Solicitud asignada:</p>
					<p>Radicado: <strong><?= $data['idpqr']; ?></strong></p>
