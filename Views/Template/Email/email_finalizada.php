		...
		<tbody>
			...
			<tr>
				<td style="text-align:justify;">				
					...
					<p>Se le informa que la solicitud con radicado <strong> <?= $data['radicado']; ?></strong> ha sido finalizada con el comentario:</p>
					<p></p>
					
					<p><?= $data['contenido']; ?></p>
					
					<a href="<?= BASE_URL; ?>/Assets/images/pqri/<?= $data['adjunto']; ?>" target="_blank" class="x_button_link x_link_blue">Documento Respuesta</a>
