<!-- Modal -->
<div class="modal fade" id="modalFormPrensa" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl" >
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="formPrensa" name="formPrensa" class="form-horizontal">
              <input type="hidden" id="idPrensa" name="idPrensa" value="">
              ...
              <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <label class="control-label">Cuerpo <span class="required">*</span></label>
              ...
              <div class="tile-footer">
                 <div class="form-group col-md-12">
                     <div id="containerGallery">
                         <span>Agregar foto (1024 x 768)</span>
