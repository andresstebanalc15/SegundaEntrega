<!-- Modal -->
<div class="modal fade" id="modalFormSlider" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form id="formSlider" name="formSlider" class="form-horizontal">
              ...
              <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                    <label class="control-label">Nombre Enlace:<span class="required"></span></label>
                    <input class="form-control" id="txtNombreUrl" name="txtNombreUrl" type="text" placeholder="Nombre Categoría" >
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Nombre Video <span class="required"></span></label>
                    <input class="form-control" id="txtNombreVideo" name="txtNombreVideo" type="text" placeholder="Nombre Categoría" >
                  </div>

                  <div class="form-group">
                    <label class="control-label">Enlace Video <span class="required"></span></label>
                    <input class="form-control" id="txtEWnlaceVideo" name="txtEWnlaceVideo" type="text" placeholder="Nombre Categoría" >
                  </div>

                    <div class="photo">
                        <label for="foto">Foto (5182x1700)</label>
                        <div class="prevPhoto">
